...
public class CodeProjectInfoWizardPage extends AbstractDataBindingWizardPage {
    ...
    protected void doCreateControls(Composite parent, DataBindingContext dbc) {
        ...
        GridDataFactory.fillDefaults().align(SWT.FILL, SWT.CENTER).applyTo(codeStartsLabel);
        Button codeStartsButton = new Button(parent, SWT.CHECK);
        GridDataFactory.fillDefaults().align(SWT.FILL, SWT.CENTER).applyTo(codeStartsButton);
